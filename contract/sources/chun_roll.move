...
module suichin::chun_roll {
    ...
    fun get_tier_image_url(tier: u8): Url {
        let url_bytes = if (tier == 1) {
            // Tier 1 - Bronze
            b"https://raw.githubusercontent.com/yourusername/suichin/main/public/nft/chunroll_tier1.png"
        } else if (tier == 2) {
            // Tier 2 - Silver
            b"https://raw.githubusercontent.com/yourusername/suichin/main/public/nft/chunroll_tier2.png"
        } else {
            // Tier 3 - Gold
            b"https://raw.githubusercontent.com/yourusername/suichin/main/public/nft/chunroll_tier3.png"
        };
