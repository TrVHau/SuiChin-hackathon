...
module suichin::achievement {
    ...
    fun get_milestone_image_url(milestone: u64): Url {
        let url_bytes = if (milestone == MILESTONE_BEGINNER) {
            b"https://raw.githubusercontent.com/yourusername/suichin/main/public/achievements/beginner.png"
        } else if (milestone == MILESTONE_SKILLED) {
            b"https://raw.githubusercontent.com/yourusername/suichin/main/public/achievements/skilled.png"
        } else if (milestone == MILESTONE_EXPERT) {
            b"https://raw.githubusercontent.com/yourusername/suichin/main/public/achievements/expert.png"
        } else if (milestone == MILESTONE_MASTER) {
            b"https://raw.githubusercontent.com/yourusername/suichin/main/public/achievements/master.png"
        } else {
            b"https://raw.githubusercontent.com/yourusername/suichin/main/public/achievements/legend.png"
        };
